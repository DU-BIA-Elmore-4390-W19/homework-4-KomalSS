...
plot(1:500, rf_train1$mse, col = "green", type = "l", xlab = "Number of Trees", ylab = "Test MSE", ylim = c(10, 19))
lines(1:500, rf_boston2$test$mse, col = "red", type = "l")
lines(1:500, rf_boston3$test$mse, col = "blue", type = "l")
legend("topright", c("m = p", "m = p/2", "m = sqrt(p)"), col = c("green", "red", "blue"), cex = 1, lty = 1)
```
As you can see from the plot the Test MSE for the sqrt of the predictors is higher than that of all predictors and half of the predictors.
## Problem 2
